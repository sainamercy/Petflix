...
function Home() {
  return (
    <div className="w-full relative">
      ...
      {/* slogan */}
      {/* get started button */}
      <div className="absolute w-full h-full top-0 bg-black/50 flex flex-col items-center justify-evenly">
        <div className="flex flex-col items-center justify-evenly text-stone-200 w-3/5 h-60" >
  ...
  <button
    ...
    class="inline-block px-10 text-1.5xl py-3 bg-cyan-400 text-stone-900 font-medium leading-tight rounded shadow-md hover:bg-cyan-700 hover:shadow-lg focus:bg-cyan-700 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
  >Get Started</button>
</div>
        </div>
      </div>
